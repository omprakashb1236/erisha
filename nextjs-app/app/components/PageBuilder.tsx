...
import { GetPageQueryResult, GetCarsQueryResult } from "@/sanity.types";
import { dataAttr } from "@/sanity/lib/utils";
import { studioUrl } from "@/sanity/lib/api";

interface PageBuilderProps {
  page: GetPageQueryResult | GetCarsQueryResult;
}
...
function renderEmptyState(page: GetPageQueryResult | GetCarsQueryResult) {
  if (!page) {
    return null;
  }
  return (
...
export default function PageBuilderPage({ page }: PageBuilderProps) {
